---
description: Here you'll find how to make your own warp category manage menu from scratch.
---
...
| `category-icon`        | Char       | The button that opens the [category icon edit menu](warp-category-icon-edit-menu.md). |
