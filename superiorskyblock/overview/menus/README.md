---
description: >-
  Menus (guis) are used in the plugin in many cases, and they are all fully
  customizable. In this documentation, you will understand how to edit them to
  your own style!
---
...
&#xNAN;_(Regular menu types should have 9 items in a row, hoppers should have 5, etc.)_\
...
{% hint style="info" %}
Note: The name of your custom menu file _**will be your sub-command**_ \
(`/is {your-sub-command}`).
{% endhint %}
