---
description: Here you'll find how to make your own members menu from scratch.
---
...
{% hint style="info" %}
Clicking a member button opens the [member manage menu](member-manage-menu.md) for that member.
{% endhint %}
